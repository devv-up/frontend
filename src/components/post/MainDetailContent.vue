        ...
        <span class="justify-start" max-width="210">
          <v-row>
            ...
            <v-col cols="12">
              ...
              <p class="ml-6 mt-3">{{postidData.author.name}}</p>
            </v-col>
